Addition of Feedback loops to increase the features captured in the Generator. - Sagar

This forked repo will be used as the starting point for the project.
# Keras-SRGAN
